...
public class MyBenchmark {
    ...
    private CombiningTree treeCounter4, treeCounter8, treeCounter16;
    ...
    public void prepare() {
		...
		treeCounter4 = new CombiningTree(4);
    ...
    @Benchmark
    public int treeCounter4() throws InterruptedException {
        return treeCounter4.getAndIncrement();
    }
