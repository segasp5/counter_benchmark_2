...
public final class MyBenchmark_synchronizedCounter {
    ...
    public Collection<? extends Result> synchronizedCounter_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while(!MyBenchmark_1_jmh.setupIterationMutexUpdater.compareAndSet(l_mybenchmark0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (!l_mybenchmark0_G.readyIteration) {
                    l_mybenchmark0_G.prepare();
                    l_mybenchmark0_G.readyIteration = true;
                }
            } finally {
                MyBenchmark_1_jmh.setupIterationMutexUpdater.set(l_mybenchmark0_G, 0);
            }

            control.announceWarmupReady();
            while (control.warmupShouldWait) {
                l_blackhole1_0.consume(l_mybenchmark0_G.synchronizedCounter());
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            synchronizedCounter_thrpt_jmhLoop(control, res, l_mybenchmark0_G, l_blackhole1_0);
            ...
            while(!MyBenchmark_1_jmh.tearIterationMutexUpdater.compareAndSet(l_mybenchmark0_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            try {
                if (l_mybenchmark0_G.readyIteration) {
                    l_mybenchmark0_G.readyIteration = false;
                }
            } finally {
                MyBenchmark_1_jmh.tearIterationMutexUpdater.set(l_mybenchmark0_G, 0);
            }
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "synchronizedCounter", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void synchronizedCounter_thrpt_jmhLoop(InfraControl control, RawResults result, MyBenchmark_1_jmh l_mybenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<? extends Result> synchronizedCounter_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            MyBenchmark_1_jmh l_mybenchmark0_G = _jmh_tryInit_f_mybenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            synchronizedCounter_avgt_jmhLoop(control, res, l_mybenchmark0_G, l_blackhole1_0);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "synchronizedCounter", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void synchronizedCounter_avgt_jmhLoop(InfraControl control, RawResults result, MyBenchmark_1_jmh l_mybenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<? extends Result> synchronizedCounter_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            MyBenchmark_1_jmh l_mybenchmark0_G = _jmh_tryInit_f_mybenchmark0_G(control, threadParams);
        ...
        int batchSize = control.iterationParams.getBatchSize();
            ...
            synchronizedCounter_sample_jmhLoop(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_mybenchmark0_G, l_blackhole1_0);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_0.consume(l_mybenchmark0_G.synchronizedCounter());
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "synchronizedCounter", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void synchronizedCounter_sample_jmhLoop(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, MyBenchmark_1_jmh l_mybenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
    ...
    public Collection<? extends Result> synchronizedCounter_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_1_jmh l_blackhole1_0 = _jmh_tryInit_f_blackhole1_0(control, threadParams);
            MyBenchmark_1_jmh l_mybenchmark0_G = _jmh_tryInit_f_mybenchmark0_G(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
        int batchSize = control.iterationParams.getBatchSize();
            synchronizedCounter_ss_jmhStub(control, batchSize, res, l_mybenchmark0_G, l_blackhole1_0);
                control.preTearDown();
            if (l_blackhole1_0.readyIteration) {
                l_blackhole1_0.readyIteration = false;
            }
            ...
            Collection<Result> results = new ArrayList<Result>();
            results.add(new SingleShotResult(ResultRole.PRIMARY, "synchronizedCounter", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void synchronizedCounter_ss_jmhStub(InfraControl control, int batchSize, RawResults result, MyBenchmark_1_jmh l_mybenchmark0_G, Blackhole_1_jmh l_blackhole1_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static class MyBenchmark_1_jmh_B1 extends my.MyBenchmark {
        private boolean pb1_0, pb1_0_1, pb1_0_2, pb1_0_3, pb1_0_4, pb1_0_5, pb1_0_6, pb1_0_7, pb1_0_8, pb1_0_9, pb1_0_10, pb1_0_11, pb1_0_12, pb1_0_13, pb1_0_14, pb1_0_15;
        private boolean pb1_1, pb1_1_1, pb1_1_2, pb1_1_3, pb1_1_4, pb1_1_5, pb1_1_6, pb1_1_7, pb1_1_8, pb1_1_9, pb1_1_10, pb1_1_11, pb1_1_12, pb1_1_13, pb1_1_14, pb1_1_15;
        private boolean pb1_2, pb1_2_1, pb1_2_2, pb1_2_3, pb1_2_4, pb1_2_5, pb1_2_6, pb1_2_7, pb1_2_8, pb1_2_9, pb1_2_10, pb1_2_11, pb1_2_12, pb1_2_13, pb1_2_14, pb1_2_15;
        private boolean pb1_3, pb1_3_1, pb1_3_2, pb1_3_3, pb1_3_4, pb1_3_5, pb1_3_6, pb1_3_7, pb1_3_8, pb1_3_9, pb1_3_10, pb1_3_11, pb1_3_12, pb1_3_13, pb1_3_14, pb1_3_15;
